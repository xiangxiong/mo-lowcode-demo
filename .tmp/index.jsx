...
const metaPathMap = {"meta":"/Users/user/za/lowcode/mo-lowcode-demo/.tmp/meta.js","meta.design":"/Users/user/za/lowcode/mo-lowcode-demo/.tmp/meta.design.js"};
  ...
  return {
    ...
    async init() {
      ...
      if (!devMode) {
        ...
        const extraAssets = ["./build/lowcode/assets-prod.json"];
        const builtinAssets = [];
