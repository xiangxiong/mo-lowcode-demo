import ColorfulButtonMeta from '/Users/user/za/lowcode/mo-lowcode-demo/lowcode/colorful-button/meta.design'
import ColorfulInputMeta from '/Users/user/za/lowcode/mo-lowcode-demo/lowcode/colorful-input/meta'
import PortalCardMeta from '/Users/user/za/lowcode/mo-lowcode-demo/lowcode/portal-card/meta'
...
function fillRealVersion(meta, packageName = 'mo-lowcode-demo', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
const componentMetas = [ColorfulButtonMeta,ColorfulInputMeta,PortalCardMeta];
const components = [];
const npmInfo = {};
...
if (!execCompile) {
  window.MoLowcodeDemoMeta = { components, componentList };
}